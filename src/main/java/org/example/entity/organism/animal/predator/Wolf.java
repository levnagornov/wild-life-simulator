...
/**
 * The {@code Wolf} class represents a wolf in the simulation.
 * It extends the {@code Predator} class, inheriting its characteristics and behavior.
 */
public class Wolf extends Predator {

    /**
     * Constructs a new wolf with the specified characteristics and current coordinate.
     *
     ...
     */
    public Wolf(Characteristics characteristics, Coordinate currentCoordinate) {
