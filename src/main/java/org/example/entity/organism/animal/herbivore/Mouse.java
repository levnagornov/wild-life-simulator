...
/**
 * The {@code Mouse} class represents a mouse in the simulation.
 * It extends the {@code Herbivore} class, inheriting its characteristics and behavior.
 */
public class Mouse extends Herbivore {

    /**
     * Constructs a new mouse with the specified characteristics and current coordinate.
     *
     ...
     */
    public Mouse(Characteristics characteristics, Coordinate currentCoordinate) {
